...
-keep class com.porsche.aaos.platform.telemetry.vehicleconnectivity.rsi.ExlapRsiSignalSubscriber { *; }
...
-keep class com.porsche.aaos.platform.telemetry.vehicleconnectivity.asi.SportChronoAsiServiceConnector { *; }
